      ...
      <Card>
        <CardContent className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <p className="text-muted-foreground max-w-md mb-6">
            We're building a seamless booking and payment system. For now, connect with brands directly through messages to negotiate and arrange collaborations offline.
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-muted-foreground">
                  Brands will message you to discuss projects. Negotiate terms and arrange payment directly with them until our booking system launches.
                </p>
              </div>
            </div>
          </div>
